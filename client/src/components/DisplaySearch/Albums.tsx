...
const Albums: React.FC<AlbumsProps> = ({
    ...
    useEffect(() => {
        const fetchAlbums = async () => {
            try {
                ...
                const shuffledAlbums = data.items.sort(() => Math.random() - 0.5);
    ...
    return (
        <div className="mt-8">
            <h2 className="text-2xl font-semibold text-white mb-4">Albums by {artistName}</h2>
                            ...
                            >
                                <div className="relative group rounded hover:bg-backgroundElevatedHighlight transition p-2">
                                    ...
                                    <p className="text-xs text-gray-400 truncate">
                                        {new Date(album.release_date).getFullYear() || "Unknown Year"} - {artistName}
                                    </p>
                                </div>
                            </div>
                        ))}
