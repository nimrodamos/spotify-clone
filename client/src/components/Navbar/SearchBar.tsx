...
const SearchBar: React.FC = () => {
    ...
    return (
        <div className="flex items-center gap-2 w-full p-1 max-w-xl ml-36">
            <div className="bg-backgroundElevatedBase rounded-full p-[0.7rem] ml-3 mt-1 hover:scale-[1.04]">
                <Link to="/">
                {isHome ? <GoHomeFill color="white" size={27} className="cursor-pointer" /> : <GoHome color="white" size={27} />}
                </Link>
            </div>
