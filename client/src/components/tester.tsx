...
const Profile: React.FC = () => {
  ...
  // Fetch random artists for Top Artists
    ...
    // Attach Scroll Listener to the Display Component
    ...
    const handleScroll = () => {
      if ((scrollableContainer as HTMLElement).scrollTop > 340) {
  ...
  return (
    <div className="min-h-screen w-full relative">
      ...
      {showStickyHeader && (
        <div
          className="absolute top-0 left-0 w-full h-[65px] bg-[#4A5A2D] flex items-center px-6 shadow-md z-10"
          style={{ color: "#fff" }}
        >
