export const SidebarLanguageSelector = () => (
    <div>
        <button
            ...
            className="flex justify-center border border-essentialSubdued text-textBase items-center px-3 py-1 mt-9 ml-6 bg-transparent text-sm font-bold rounded-full"
        >
