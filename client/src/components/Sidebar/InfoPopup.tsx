...
const InfoPopup: React.FC<{ onClose: () => void }> = ({ onClose }) => {
    ...
    return (
        <div ref={popupRef} className="absolute top-12 left-0 bg-gradient-to-r from-blue-300 to-blue-500 text-black p-4 rounded-md shadow-lg w-90 animate-slide-in-left before:content-[''] before:absolute before:right-full before:mt-12 before:border-8 before:border-transparent before:border-r-blue-500 z-50">
